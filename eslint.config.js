...
export default tseslint.config(
  {
    ignores: [
      ...
      "fixtures/**",
      "golden/**",
      // Generated by the Prisma client generator on every install. Linting it reports
      // other people's style choices in a file nobody can edit and everybody regenerates.
